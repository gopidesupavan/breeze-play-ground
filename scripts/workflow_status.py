...
def workflow_status(
    ...
    if result.returncode != 0:
        console.print(f"[red]Error fetching workflow run ID: {result.stderr}[/red]")
        sys.exit(1)
    ...
    console.print(f"[blue]Workflow status for {workflow_id:} {runs_data}[/blue]")
    return json.loads(runs_data)
...
if __name__ == "__main__":
    ...
    data = workflow_status(branch, workflow_id)
